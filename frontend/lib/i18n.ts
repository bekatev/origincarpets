...
export const dictionaries = {
  ...
  ka: {
    ...
    home: {
      ...
      heroBody:
        'გაეცანით ჩვენს ფრთხილად შერჩეულ კოლექციას — ვინტაჟური და თანამედროვე ხელნაქსოვი ხალიჩები კავკასიიდან. თითოეული ნაწარმოები ჩვენი ექსპერტების მიერ არის შერჩეული ისტორიული სავაჭრო გზებიდან, რომლებიც ადრე აღმოსავლესა და დასავლეთს უკავშირდებოდა.',
